...
L_values = linspace(0.001,100,100);
inductanceNum = length(L_values);
NumDValues = 100;

poleVector = zeros([NumDValues, inductanceNum]);

for k = 1:inductanceNum
% System parameters
H=1;
V=100;
R=100;
...
writematrix(poleVector, "poles_inductance_damping.xlsx");
